...
outputdir= "/media/windows-share/London/cls5sep" #Name directory where output needs to be stored
...
g.shell.GGIR(#=======================================
             ...
             maxdur = 1, # How many DAYS of measurement do you maximumally expect?
