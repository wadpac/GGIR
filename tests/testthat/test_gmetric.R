...
test_that("g.getmetric calculates the correct metric values", {
  ...
  T1 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=1,TW=TW,lb=lb,hb=hb,gravity = 1) # HFEN
  T3 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=3,TW=TW,lb=lb,hb=hb,gravity = 1) # EN
  T5 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=5,TW=TW,lb=lb,hb=hb,gravity = 1) # HFENplus
  T7 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=7,TW=TW,lb=lb,hb=hb,gravity = 1) # BFEN
  T9 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=9,TW=TW,lb=lb,hb=hb,gravity = 1) # LFENMO
  T11 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=11,TW=TW,lb=lb,hb=hb,gravity = 1) # angles
  T12 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=12,TW=TW,lb=lb,hb=hb,gravity = 1) # AENMO
  T13 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=13,TW=TW,lb=lb,hb=hb,gravity = 1) # rolling median (roll_med_acc)
  T14 = g.metric(Gx,Gy,Gz,n=n,sf=sf,ii=14,TW=TW,lb=lb,hb=hb,gravity = 1) # direction specific acceleration (dev_roll_med_acc)
