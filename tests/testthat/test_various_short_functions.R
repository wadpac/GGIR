library(GGIR)
context("various short functions")
test_that("various short functions perform well", {
  
  # These functions were written by Joe Heywood around 2016
  # and only used for Milenium cohort data
  ...
  expect_equal(out3[1,2], "01/05/13 02:00:00")
})
