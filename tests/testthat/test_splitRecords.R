...
test_that("Recording can be split", {
  ...
  expect_true(file.exists("./testfolder/meta/basic/meta_1_bin_split1.RData"))
  expect_true(file.exists("./testfolder/meta/basic/meta_1_bin_split2.RData"))

  # File content correct?
  load("./testfolder/meta/basic/meta_1_bin_split1.RData")
  expect_equal(nrow(M$metashort), 8100)
  expect_equal(nrow(M$metalong), 46)
  ...
  expect_equal(tail(M$metalong$timestamp, n = 1), "2013-11-14T23:00:00+0000")
  load("./testfolder/meta/basic/meta_1_bin_split2.RData")
  expect_equal(nrow(M$metashort), 10619)
  expect_equal(nrow(M$metalong), 59)
