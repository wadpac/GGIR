...
test_that("timegaps are correctly imputed", {
  ...
  x1[zeros, xyzCol] = 0
  x1_imputed = g.imputeTimegaps(x1, xyzCol, timeCol = "time", sf = sf, impute = TRUE)
  x1_removed = g.imputeTimegaps(x1, xyzCol, timeCol = "time", sf = sf, impute = FALSE)
  ...
  x2[zeros, xyzCol] = 0
  x2_imputed = g.imputeTimegaps(x2, xyzCol, timeCol = "time", sf = sf, impute = TRUE)
  x2_removed = g.imputeTimegaps(x2, xyzCol, timeCol = "time", sf = sf, impute = FALSE)
  ...
  zeros = c(7000:7500, 8000:8500)
  x3[zeros, xyzCol] = 0
  x3_imputed = g.imputeTimegaps(x3, xyzCol, sf = sf, impute = TRUE)
  x3_removed = g.imputeTimegaps(x3, xyzCol, sf = sf, impute = FALSE)
