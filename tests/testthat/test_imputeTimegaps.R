...
test_that("timegaps are correctly imputed", {
  ...
  x1 = x[-zeros,]
  x1_imputed = g.imputeTimegaps(x1, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = TRUE, LastValueInPrevChunk = c(0,0,1))
  x1_removed = g.imputeTimegaps(x1, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = FALSE, LastValueInPrevChunk = c(0,0,1))
  
  # Format 2: with timestamp & with zeros (complete dataset)
  x2 = x
  x2[zeros, xyzCol] = 0
  x2_imputed = g.imputeTimegaps(x2, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = TRUE, LastValueInPrevChunk = c(0,0,1))
  x2_removed = g.imputeTimegaps(x2, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = FALSE, LastValueInPrevChunk = c(0,0,1))
  
  # Format 3: without timestamp & with zeros (complete dataset)
  x3 = x_without_time
  x3[zeros, xyzCol] = 0
  x3_imputed = g.imputeTimegaps(x3, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = TRUE, LastValueInPrevChunk = c(0,0,1))
  x3_removed = g.imputeTimegaps(x3, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = FALSE, LastValueInPrevChunk = c(0,0,1))
  ...
  x4 = x[-zeros,]
  LastTimeInPrevChunk = x[1,"time"] - 30 # dummy gap of 30 seconds between chunks
  suppressWarnings({ # warning arising from made up LastTimeInPrevChunk
    x4_imputed = g.imputeTimegaps(x4, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = TRUE, 
                                  LastValueInPrevChunk = c(0,0,1), LastTimeInPrevChunk = LastTimeInPrevChunk)
  ...
  x5 = x
  x5[zeros, xyzCol] = 0
  x5_imputed = g.imputeTimegaps(x5, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = TRUE, LastValueInPrevChunk = c(0,0,1))
  x5_removed = g.imputeTimegaps(x5, xyzCol, timeCol = "time", sf = sf, k = 2/sf, impute = FALSE, LastValueInPrevChunk = c(0,0,1))
