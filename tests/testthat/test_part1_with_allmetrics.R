...
test_that("Part 1 can run with all metrics", {
  ...
  expect_equal(nrow(M$metashort), 17280)
  expect_equal(mean(M$metashort$BFEN),  0.029906, tolerance = 4)
  expect_equal(mean(M$metashort$LFENMO),  0.02915305, tolerance = 4)
  expect_equal(mean(M$metashort$HFENplus),  0.05967898, tolerance = 4)
  expect_equal(mean(M$metashort$MAD),  0.004746672, tolerance = 4)
  expect_equal(mean(M$metashort$anglex),  37.50799, tolerance = 4)
  expect_equal(mean(M$metashort$anglez),  0.2238204, tolerance = 4)
  expect_equal(mean(M$metashort$ZCX),  9.752199, tolerance = 2)
