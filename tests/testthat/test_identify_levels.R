...
test_that("identify_levels", {
  ...
  levels = identify_levels(time,diur,detection,ACC,
                             ...
                             ws3=5,bout.metric=4)
  expect_that(table(levels$LEVELS)[1],equals(403))
  expect_that(table(levels$LEVELS)[3],equals(553))
  expect_that(table(levels$LEVELS)[5],equals(452))
  expect_that(table(levels$LEVELS)[7],equals(617))
  expect_that(table(levels$OLEVELS)[2],equals(639))
  expect_that(table(levels$OLEVELS)[4],equals(787))
  expect_that(levels$Lnames[12],equals("INB_D10T40"))
  expect_that(table(as.numeric(levels$bc.in))[2],equals(1833))
