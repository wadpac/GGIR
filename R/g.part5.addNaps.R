      ...
      if (length(sibnaps) > 0) {
        ...
        for (sni in 1:length(sibnaps)) {
          ...
          if (length(sibnap) > 0) {
            ...
            if (params_sleep[["nap_invalid_crit"]] < 1) {
            ...
            # - Surrounding hour has more than 25% sib
            ...
            if (fractionInvalid <= params_sleep[["nap_invalid_crit"]] &&
                ACCp95 < accThreshold &&
                fractionRest > 0.25) {
              ...
              # possible_nap_dur c(0, 10, 30) with nap_dur_min = 15, will result in 3
