g.binread = function(binfile, start = 0, end = 0) {
  stop(paste0("Function g.binread for GENEA binary data reading has been depricated because",
              " R package matlab was archived. Once R package matlab is back on CRAN we", 
              " will reinsert gbinread. In the mean time use older version of R", 
              " package GGIR (2.6-6 or earlier) and matlab (1.0.2 or earlier)"))
  # 
  # int16 = function(x) {
  #   x[x < -32768] = -32768
  #   x[x > 32767] = 32767
