g.getmeta = function(datafile,desiredtz = "",windowsizes = c(5,900,3600),
        ...
        } else if (mon == 2 | (mon == 4 & dformat == 4)  | (mon == 5 & dformat == 1) | (mon == 0 & length(rmc.col.temp) > 0)){
                temp.available = TRUE
        }
        ...
        while (LD > 1) {
                ...
                if (useRDA == FALSE) {
                        ...
                        rm(accread); gc()
                        #Temperature read
                        if (mon == 5) { #only for movisens
                                #Resample temperature data for calibration
                ...
                if (length(P) > 0) { #would have been set to zero if file was corrupt or empty
                        if (useRDA == FALSE) {
                                ...
                                if (mon == 2 | (mon == 4 & dformat == 4) | (mon == 5 & use.temp == TRUE)) {
                                        ...
                                        if (mon == 4 | mon == 0) tempcolumn = 5
                                        if (mon == 5) tempcolumn = 4
                                ...
                                if (i == 1 | (i != 1 & length(selectdaysfile) > 0)) { #only do this for first block of data
                                        ##################SEGUIR AQUÍ################################
                                        #Adaptar g.getstarttime para que use la función de unisensR en movisens
                        ...
                        if (LD >= (ws*sf)) {
                                if (useRDA == FALSE) {
                                        ...
                                        data = as.matrix(data)
                                        #--------------------------------------------
                                        if (mon == 2 | (mon == 4 & dformat == 4) | (mon == 5 & dformat == 1) | 
                                            (mon == 0 & length(rmc.col.temp) > 0)) {
                                                if (mon == 2) {
