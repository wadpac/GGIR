g.report.part5 = function(metadatadir = c(), f0 = c(), f1 = c(), loglocation = c(),
  ...
  if (length(params_cleaning[["includedaycrit"]]) != 0 & length(params_cleaning[["includedaycrit.part5"]]) == 0) params_cleaning[["includedaycrit.part5"]] = params_cleaning[["includedaycrit"]]
  getValidDayIndices = function(x, includedaycrit.part5, excludefirstlast.part5, window,
                                segmentWEARcrit.part5, segmentDAYSPTcrit.part5,
    ...
    if (window != "Segments") {
      ...
      } else if (includedaycrit.part5 > 1 & includedaycrit.part5 <= 25) { # if includedaycrit.part5 is used like params_cleaning[["includedaycrit"]] as a number of hours
