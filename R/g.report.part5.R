                ...
                agg_plainNweighted = function(df,filename="filename",daytype="daytype") {
                  ...
                  add_missing_LUX = function(x, weeksegment=c()) {
                    ...
                    if (length(weeksegment) > 0) {
                      LUX_hour_variables_expected = paste0("LUXmetric_",LUX_day_segments[1:(NLUXseg-1)],"-",LUX_day_segments[2:(NLUXseg)],"hr_day_",weeksegment)
                    } else {
                      LUX_hour_variables_expected = paste0("LUXmetric_",LUX_day_segments[1:(NLUXseg-1)],"-",LUX_day_segments[2:(NLUXseg)],"hr_day")
                    }
