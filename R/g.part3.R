g.part3 = function(metadatadir=c(),f0,f1,anglethreshold = 5,timethreshold = 5, 
                   ...
                   constrain2range=TRUE,do.part3.pdf=TRUE, do.parallel = TRUE,dayborder=0) {
      ...
      if (skip == 0) {  
        ...
        if (M$filecorrupt == FALSE & M$filetooshort == FALSE) {
          ...
          SLE = g.sib.det(M,IMP,I,twd=c(-12,12),timethreshold=timethreshold,anglethreshold=anglethreshold,
                          acc.metric=acc.metric,desiredtz=desiredtz,constrain2range=constrain2range, dayborder=dayborder)
          L5list = SLE$L5list
