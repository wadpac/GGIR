g.part6 = function(datadir = c(), metadatadir = c(), f0 = c(), f1 = c(),
                   params_247 = c(), params_phyact = c(), verbose = TRUE, ...) {
  ...
  params = extract_params(params_247 = params_247,
                          ...
                          input = input, params2check = c("247", "phyact"))
  ...
  fnames.ms5raw = dir(paste0(metadatadir, "/meta/ms5.outraw/", params_247[["part6_threshold_combi"]]))
  fnames.ms6 = dir(paste(metadatadir, "/meta/ms6.out", sep = ""))
  ffdone = fnames.ms6
  #------------------------------------------------
  # specify parameters
  ffdone = fnames.ms6 # ffdone is now a list of files that have already been processed by g.part6
  ...
  main_part6_recordlevel = function(i, metadatadir = c(), f0 = c(), f1 = c(), 
    ...
    if (skip == 0) {
      ...
      load(file = paste0(metadatadir, "/meta/ms5.outraw/",
                         params_247[["part6_threshold_combi"]], fnames.ms5raw[i]))
