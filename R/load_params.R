load_params = function(topic = c("sleep", "metrics", "rawdata",
  ...
  if ("sleep" %in% topic) {
    params_sleep = list(anglethreshold = 5, timethreshold = 5,
                        ...
                        possible_nap_1min_before_acc = Inf,
                        possible_nap_1min_after_acc = Inf,
                        possible_nap_acc_mean = c(0, Inf),
                        possible_nap_angle_stdev = c(0, Inf),
                        nap_overwrite_behaviourclass = TRUE,
