...
As for the rest of GGIR functions, `read.myacc.csv` is intended to be used within `g.shell.GGIR`. All the arguments of the `read.myacc.csv` can be easily recognized as they all start by "rmc". The g.shell.GGIR function checks whether the argument rmc.firstrow.acc is provided by the user; in such case, GGIR will derive the reading of the data to the `read.myacc.csv`.
