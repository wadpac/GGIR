...
| anglex             | Rolling median of a 10 Hertz version of the signals followed by atan(x / (sqrt(y^2^ + z^2^))) / (pi/180)                                                       | Average           | do.anglex                                                                   | Frequency               |
| angley             | Rolling median of a 10 Hertz version of the signals followed by atan(y / (sqrt(x^2^ + z^2^))) / (pi/180)                                                       | Average           | do.angley                                                                   | Frequency               |
| anglez             | Rolling median of a 10 Hertz version of the signals followed by atan(z/ (sqrt(x^2^ + y^2^))) / (pi/180)                                                        | Average           | do.anglez                                                                   | Frequency               |
| roll_med_acc_x     | Rolling median of a 10 Hertz version of x-axis                                                                                                                 | Average           | do.roll_med_acc_x                                                           | Frequency               |
| roll_med_acc_y     | Rolling median of a 10 Hertz version of y-axis                                                                                                                 | Average           | do.roll_med_acc_y                                                           | Frequency               |
| roll_med_acc_z     | Rolling median of a 10 Hertz version of z-axis                                                                                                                 | Average           | do.roll_med_acc_z                                                           | Frequency               |
...
In fact, this allows you to include entire algorithms such as the [step detection](https://github.com/ShimmerEngineering/Verisense-Toolbox/tree/master/Verisense_step_algorithm) or other [sleep classification algorithms](https://github.com/wadpac/Sundararajan-SleepClassification-2021/tree/master/ggir_ext).
