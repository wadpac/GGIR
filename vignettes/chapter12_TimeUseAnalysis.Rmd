...
By default GGIR segments a window in waking hours of the day (referred to as `day`) and the sleep period time window (referred to as `spt`). Additionally, day segment specific analysis are performed based on the segments as defined by parameters `qwindow` . Please see the annex on day segmentation for more information.
