...
| maxRecordingInterval        | between 1 and 2   | params_general           |
| recording_split_times       | between 1 and 2   | params_general           |
| recording_split_overlap     | between 1 and 2   | params_general           |
| recording_split_timeformat  | between 1 and 2   | params_general           |
