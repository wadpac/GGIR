...
Simply apply GGIR function `g.shell.GGIR` as you would do with accelerometer-only data and the code will automatically use the gyroscope data. For the moment it only extracts metric `sgAccEN` as epoch level summary of the data, which represents the epoch level average of the magnitude of acceleration after separation of the gravitational component. To skip the procedure set argument do.sgAccEN = FALSE.
