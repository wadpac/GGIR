...
output:
  html_document:
    ...
    toc_float: yes
urlcolor: blue
vignette: "%\\VignetteIndexEntry{Household Co-Analysis} \\usepackage[utf8]{inputenc}
...
acc_wake1_before_wake2 | Mean acceleration of the person who wakes up first during the four minutes before the second person wakes up
