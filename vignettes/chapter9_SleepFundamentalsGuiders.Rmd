...
The reason we consider LowAcc instead of NonWorn for thigh-worn ActivPAL data is that non-wear is more difficult to detect when sensor is worn on the thigh and we observed that the  ActivPAL emits much more noise than other sensor brands, complicating an accurate distinction between non-wear and inactivity.

A more elaborate motivation and justification for this experimental guider will hopefully follow in a journal article.
