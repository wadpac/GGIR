...
Step 3 comes with the assumption that the main sleep period typically takes place in the same part of the day for one individual. If you disagree and would like to skip step 3 set parameter `guider_cor_meme_min_dys = Inf`.
