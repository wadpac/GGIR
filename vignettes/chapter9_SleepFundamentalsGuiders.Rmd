...
1. Apply default guider (e.g. HDCZA) to each night, but retain all candidate sleep blocks whereas normally we would only retain the longest block and use that as main guider window.
2. Identify min-max window running from the minimum sleep onset to maximum wakeup time from all main guider windows across all nights in one recording.
