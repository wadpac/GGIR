...
mode' on will have imputed values in all three axes during periods of no
movement. Note that ActiGraph has changed the imputation at some point in time.
Initially the imputation was zeros but with more recent versions of ActiLife the
imputation uses the last recorded value for each axes.
