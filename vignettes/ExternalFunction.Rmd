...
In this example we will apply the function counts() from R package [activityCounts](https://cran.r-project.org/web/packages/activityCounts/index.html) to the raw data, which produces an estimate of Actigraph counts per second.
