...
- `timestamp` Boolean to indicated whether timestamps should be passed on to the external fucntion as first columm of the data matrix.
...
In this example we will use an external Python code to estimate the dominant signal frequency per acceleration axis.
