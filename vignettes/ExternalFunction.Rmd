...
Algorithms (e.g. machine learning models) are typically developed for a specific data format without initially considering the data cleaning and aggregation steps needed for real life 'out of the lab' implementation. GGIR can take care of this by allowing you to provide your external function written in R or Python. GGIR applies your function to the the data and integrates the output it its own output.
