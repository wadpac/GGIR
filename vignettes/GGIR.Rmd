...
**Institutions:** The MRC Epidemiology Unit at the University of Cambridge, Movelab at Newcastle University, the Netherlands eScience Center, and the University of Exeter as host organisations
...
You can use ```source("pathtoscript/myshellscript.R")``` or use the Source button in RStudio if you use RStudio.
