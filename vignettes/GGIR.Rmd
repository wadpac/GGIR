...
[Download and install RStudio](/products/rstudio/) (optional, but recommended)
...
1. GGIR works with the following accelerometer brands and formats:
    - [GENEActiv](https://geneactiv.org/) .bin and .csv
...
PMID: 25103964 [link](https://journals.physiology.org/doi/10.1152/japplphysiol.00421.2014)
...
4. van Hees VT, Fang Z, et al. Auto-calibration of accelerometer data for free-living physical activity assessment using local gravity and temperature: an evaluation on four continents. J Appl Physiol 2014. [link](https://journals.physiology.org/doi/10.1152/japplphysiol.00421.2014)
