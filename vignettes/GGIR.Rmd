...
| file.too.short	         | File to short for processing? TRUE or FALSE |
| use.temperature	| Temperature used for auto-calibration? TRUE or FALSE |
| scale.x	| Auto-calibration scaling coefficient for x-axis (same for y and z axis, not show here) |
| offset.x	| Auto-calibration offset coefficient for x-axis (same for y and z axis, not show here) |
| temperature.offset.x | Auto-calibration temperature offset coefficient for x-axis (same for y and z axis, not show here) |
