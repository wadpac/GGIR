...
Please, visit the [cut-points vignette](https://cran.r-project.org/package=GGIR/news.html)
for more details on the cut-points available, how to use them, and some additional
refletions on the use of cut-points in GGIR.
