...
There is a large variation in the study protocols to collect accelerometer data
nowadays (e.g., number of days that are recorded, wearing or not the device during 
sleep, among others). GGIR includes a number of arguments to 
