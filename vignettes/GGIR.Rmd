...
If you need dedicated support with the use of GGIR or need someone to adapt GGIR then Vincent van Hees is available as [independent consultant](https://www.accelting.com/).
...
In ActiLife you have the option to export data with timestamps. Please do not do this as this causes memory issues. To cope with the absence of timestamps GGIR will re-caculate timestamps from the sample frequency and the start time and date as presented in the file header.
...
guider | guider used (see paragraph 'Waking-waking or 24 hour time-use analysis').
...
cleaningcode | see paragraph 'Waking-waking or 24 hour time-use analysis').
