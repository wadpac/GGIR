...
Documentation for this parameter objects can be found the vignette 
[Description of configuration parameters in GGIR](https://cran.r-project.org/package=GGIR),
which technically is identical to the information provided in the [GGIR
