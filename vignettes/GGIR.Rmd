...
- Number of fragment per minutes (`NFragPM`) is calculated similar to metric `fragmentation` in Chastin et al. doi: 10.1093/ageing/afr075, but renamed to be a more accurate reflection of the calculation.
