...
**GGIR training** We offer frequent online GGIR training courses, both
standard training on GGIR (3 x 3 hours) and private training to focus on
your outstanding issues (3 x 2 hours). Check our dedicated training
...
Please, visit the [cut-points
vignette](https://cran.r-project.org/package=GGIR/news.html) for more
details on the cut-points available, how to use them, and some
additional refletions on the use of cut-points in GGIR.
