...
The signal processing includes automatic calibration, detection of sustained abnormally high values, detection of non-wear and calculation of average magnitude of dynamic acceleration based on a variety of metrics.

_I started assembling this vignette in May 2017 and not all sections may be optimal yet, if you have feedback please get in touch_
...
You will need to copy paste the g.shell.GGIR function call to the  `myshellscript.R`.
...
- The [GGIR package manual](https://cran.r-project.org/web/packages/GGIR/GGIR.pdf) provides documentation on individual functions.
...
2. van Hees VT, Fang Z, et al. Auto-calibration of accelerometer data for free-living physical activity assessment using local gravity and temperature: an evaluation on four continents. J Appl Physiol 2014. [link](http://jap.physiology.org/cgi/pmidlookup?view=long&pmid=25103964)
3. van Hees VT, Sabia S, et al. A novel, open access method to assess sleep duration using a wrist-worn accelerometer, PLoS ONE, 2015 [link](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0142533)
