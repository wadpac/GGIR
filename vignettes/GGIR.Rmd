...
combination with argument `part5_epochSizes = c(5, 60)` as that will
aggregate the time series to 1 minute resolution for the fragmentation analysis
withou affecting the time-use classification. One-minute resolution is common in
the behavioural fragmentation literature.
