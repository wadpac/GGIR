...
IS_interdailystability | inter daily stability. Note: The movement count that is derived for this was an attempt to adhere to original approach, we are currently looking for researchers willing to help evaluate this implementation.
IV_intradailyvariability | intra daily variability. Note: Same note as for IS_interdailystability.
