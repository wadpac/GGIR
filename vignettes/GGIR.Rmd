...
SleepRegularityIndex | The Sleep Regularity Index as proposed by Phillips et al. 2017 https://www.nature.com/articles/s41598-017-03171-4, but calculated per day-pair to enable user to study patterns across across days and decide which day pairs are included at the personal level aggregate.
SriFractionValid | Fraction of the 24 hour period that was valid in both current as well
as in matching timestamps for the next calendar day.
