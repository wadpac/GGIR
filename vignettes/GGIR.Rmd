...
3. Give the folder an appropriate name, e.g. studyname_data
4.	Create a folder where the output will be stored. This should also be on the external hard drive. Give the folder an appropriate name, e.g. studyname_output
