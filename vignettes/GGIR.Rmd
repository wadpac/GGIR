...
-	For both MM and WW defined days: is that tThe invalid time percentage during waking hours needs to be below a certain percentage, defined as: 100 x (1 – (the value of argument includedaycrit divided by 24)), with default 100 x (1-(16/24)) = 33%.
