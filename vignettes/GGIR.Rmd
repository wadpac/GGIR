...
- For both MM and WW defined days: The invalid (non-wear) time percentage during sleep period time hours needs to be below 66% if no sleeplog is used. The 66% is currently not modifiable by the user.
