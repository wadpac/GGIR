...
In part 5, information about the segments of the days are exported in different files
than the person-level and day-level summaries. These files include the word "Segments"
in the filename and are provided in the long format and aggregated per day and per person:
...
# Cleaning parameters for day segments

The analyses performed per segment of the day come with the possibility to 
...
These cleaning parameters are only available in part 5:
...
total version of the variables. See [description](https://cran.r-project.org/web/packages/GGIR/vignettes/GGIR.html#41_Output_part_5:~:text=as%3A%20sleeponset%20%2D%20guider_inbedStart-,4.3%20Output%20part%205,-The%20output%20of) of GGIR part 5 output in the main GGIR vignette for further details.
