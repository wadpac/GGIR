...
This to ensure that segment length is identical across days of the week, which is needed to ease comparison time-use and other outcome variables across days.
