...
In [Chapter 2](https://wadpac.github.io/GGIR/articles/chapter2_Pipeline.html#externally-derived-epoch-level-data) we already provided an overview of all brands and data formats facilitated.
...
parameter `extEpochData_timeformat` setting is correct for the data you are processing. You can do this by opening one of the files in notepad or eclipse. See [our Annex page](https://wadpac.github.io/GGIR/articles/DateTimeFormatsInR.html) for guidance on how to specify date and time formats in R.

## Actiwatch data

This includes the Actiwatch Spectrum Plus and Actiwatch 2 (AW2) as sold by Philips Respironics (previously Mini Mitter) the MotionWatch from CamNTech.
...
Note: We have only tested this for the FitBit Inspire 3 model. It is unclear to us whether other versions of the Fitbit watch allow for data to be exported in a similar format.
