...
The GENEActiv accelerometer can be configured to record at 85.7 Hertz. As of GGIR 3.3-2 the data is automatically resampled to 86 Hertz to ease summarising the data per epoch, e.g. 1 second or 5 seconds. This only applies to GENEActiv with 85.7 Hertz configuration.
