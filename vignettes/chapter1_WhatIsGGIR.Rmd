...
All documentation text has been written in the 'we'-form for even though some parts  have been written by just one person (Vincent). Switching between 'I' and 'we' for each section depending on who has been involved in the writing would seem unpractical.
