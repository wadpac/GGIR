...
- GGIR detected sleep period time window minus WASO episodes that last at least 30 minutes.
...
The 'sleepreg' package comes various options to modify the configuration of the calculation as discussed in the package documentation and in the supplementary materials to [Windred et al. 2021](https://doi.org/10.1093/sleep/zsab254).
