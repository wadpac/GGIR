...
If you are concerned that sleep estimates are not reliable without being guided by sleeplog, then use parameter `require_sleeplog_part5 = TRUE`. This forces the GGIR part 5 csv output to only keep day window that are both preceded and succeeded by an SPT window that is guided by sleeplog.
